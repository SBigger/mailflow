-- ─────────────────────────────────────────────────────────────────
-- fibu_delete_kreditoren_beleg v2: Bedingungen lockern
-- Neu: Status-Einschränkung fällt weg – nur Bezahlt + MWST-Abrechnung
-- blockieren die Löschung noch.
-- ─────────────────────────────────────────────────────────────────
...
BEGIN
  ...
  -- MWST-Abrechnung blockiert Löschen
  ...
  -- Positionen, Buchungen und Beleg löschen
