-- =====================================================================
-- FiBu: Kontoblatt v3 – ergänzt lieferant_name für Textspalte
-- Zeigt Lieferantenname (Zeile 1) + Buchungstext (Zeile 2)
-- =====================================================================
...
RETURNS TABLE (
  ...
  quelle_id       UUID,
  buch_text       TEXT,
  lieferant_name  TEXT,   -- NEU: Name des Lieferanten (aus fibu_lieferanten via quelle_id)
  mwst_code       TEXT,
  mwst_betrag     NUMERIC,
