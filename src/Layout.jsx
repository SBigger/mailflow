...
import { LayoutDashboard, Mail, CheckSquare, Settings as SettingsIcon, Building2, CalendarClock, LifeBuoy, BookOpen } from "lucide-react";
...
export default function Layout({ children, currentPageName, onMailFilterAction, onShowCompletedToggle, onRefresh, isSyncing }) {
  ...
  const activeNavBg = isArtis ? '#7a9b7f' : 'bg-violet-600';
