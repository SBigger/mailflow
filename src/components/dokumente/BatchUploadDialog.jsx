...
function iconForFile(file) {
  ...
  if (name.endsWith(".xlsx") || name.endsWith(".xls") || name.endsWith(".csv")) return <FileSpreadsheet size={18} />;
  if (name.endsWith(".pdf") || name.endsWith(".docx") || name.endsWith(".txt") || name.endsWith(".md")) return <FileText size={18} />;
  return <File size={18} />;
}
