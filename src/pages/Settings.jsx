            ...
            <div className="flex-1 p-8 overflow-y-auto">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-xl p-6 border"
                            ...
                            <p className="mb-2" style={{color: textMuted}}>
                                Löscht alle deine Mails und synchronisiert die letzten <strong
                                style={{color: headingColor}}>{syncDays} Tage</strong> neu von Outlook.
                            </p>
                            <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-lg mb-4">
                                <p className="text-red-400 text-sm">⚠️ Alle bestehenden E-Mails werden unwiderruflich
                                    gelöscht und neu synchronisiert!</p>
                            </div>
                            {!user?.microsoft_access_token && !user?.microsoft_refresh_token ? (
                                <p className="text-zinc-500 text-sm">Zuerst mit Outlook verbinden.</p>
                            ) : (
                                <Button onClick={handleFirstSync} disabled={isSyncing}
                ...
                {activeTab === 'priorities' && (
                    <div>
                        <div className="rounded-xl p-6 border"
                             style={{backgroundColor: cardBg, borderColor: cardBorder}}>
                            <h3 className="text-lg font-semibold mb-4" style={{color: headingColor}}>Task-Prioritäten
                                verwalten</h3>
                            ...
                            {isAdding ? (
                                <div className="rounded-lg p-4 mb-6 border"
                                     style={{backgroundColor: rowBg, borderColor: rowBorder}}>
                                    <h4 className="text-sm font-semibold mb-4" style={{color: headingColor}}>Neue
                                        Priorität</h4>
                                    <div className="grid grid-cols-3 gap-4 mb-4">
                                        <div className="space-y-2">
                                            <label className="text-xs" style={{color: textMuted}}>Name</label>
                                            <Input value={newName} onChange={(e) => setNewName(e.target.value)}
                                                   placeholder="z.B. Kritisch" style={{
                                                backgroundColor: inputBg,
                                                borderColor: inputBorder,
                                                color: inputColor
                                            }}/>
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-xs" style={{color: textMuted}}>Stufe (1 =
                                                höchste)</label>
                                            <Input type="number" min="1" value={newLevel}
                                                   onChange={(e) => setNewLevel(parseInt(e.target.value) || 1)} style={{
                                                backgroundColor: inputBg,
                                                borderColor: inputBorder,
                                                color: inputColor
                                            }}/>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input type="color" value={newColor}
                                                   onChange={(e) => setNewColor(e.target.value)} className="w-16 h-10"
                                    ...
                                    <div className="flex gap-2 flex-wrap mb-4">
                                        {predefinedColors.map((color) => (
                                            <button key={color} onClick={() => setNewColor(color)}
                                                    ...
                                                    style={{backgroundColor: color, borderColor: rowBorder}}/>
                                        ))}
                                    </div>
                                    <div className="flex gap-2">
                                        <Button onClick={handleAddPriority} className="bg-green-600 hover:bg-green-500"><Plus
                                            className="h-4 w-4 mr-2"/> Erstellen</Button>
                                ...
                                <Button onClick={() => setIsAdding(true)}
                                        className="bg-indigo-600 hover:bg-indigo-500 mb-6"><Plus
                                    className="h-4 w-4 mr-2"/> Neue Priorität</Button>
                            )}

                            {/* Priority List */}
                            <div className="space-y-3">
                                {priorities.length === 0 ? (
                                    <p className="text-sm py-4" style={{color: textMuted}}>Noch keine Prioritäten
                                        definiert</p>
                                ) : (
                                        ...
                                        <div key={priority.id}
                                            ...
                                            {editingId === priority.id ? (
                                                <div className="flex-1 flex gap-2">
                                                    ...
                                                    <Input type="number" min="1" value={editLevel}
                                                           onChange={(e) => setEditLevel(parseInt(e.target.value) || 1)}
                                                           className="w-20" style={{
                                                        backgroundColor: inputBg,
                                                        borderColor: inputBorder,
                                                        color: inputColor
                                                    }}/>
                                                    <Input type="color" value={editColor}
                                                           ...
                                                           className="w-12 h-10" style={{
                                                        backgroundColor: inputBg,
                                                        borderColor: inputBorder
                                                    }}/>
                                                    <Button size="sm" onClick={saveEdit}
                                                            className="bg-green-600 hover:bg-green-500"><Save
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <div className="font-medium"
                                                                 style={{color: headingColor}}>{priority.name}</div>
                                                            <div className="text-xs"
                                                                 style={{color: textMuted}}>Stufe {priority.level}</div>
                                                        </div>
                                                    </div>
                    ...
                    <div>
                        <div className="rounded-xl p-6 border"
                            ...
                            <div className="flex gap-2 mb-6">
                                <Input value={newTag.name}
                                       onChange={(e) => setNewTag({...newTag, name: e.target.value})}
                                       placeholder="Neuer Tag-Name"
                                       style={{backgroundColor: inputBg, borderColor: inputBorder, color: inputColor}}/>
                                <input type="color" value={newTag.color}
                                       onChange={(e) => setNewTag({...newTag, color: e.target.value})}
                                       className="w-12 h-10 rounded" style={{borderColor: inputBorder}}/>
                                <Button
                                    ...
                                    <div key={tag.id}
                                        ...
                                        {editingTag?.id === tag.id ? (
                                            <div className="flex items-center gap-2 flex-1">
                                                <Input value={editingTag.name} onChange={(e) => setEditingTag({
                                                    ...editingTag,
                                                    name: e.target.value
                                                })} className="flex-1" style={{
                                                    backgroundColor: inputBg,
                                                ...
                                                <Button size="sm" onClick={() => updateTagMutation.mutate({
                                                    id: tag.id,
                                            ...
                                            <>
                                                ...
                                                <div className="flex gap-1">
                                                    <Button variant="ghost" size="sm" onClick={() => setEditingTag({
                                                        id: tag.id,
                                                        name: tag.name,
                ...
                {activeTab === 'projects' && (
                    <div>
                        <div className="rounded-xl p-6 border"
                             style={{backgroundColor: cardBg, borderColor: cardBorder}}>
                            <h3 className="text-lg font-semibold mb-4" style={{color: headingColor}}>Projekte
                                verwalten</h3>
                                ...
                                {projects.map((project) => (
                                    <div key={project.id}
                                        ...
                                        <div className="flex items-center gap-3 flex-1">
                                            ...
                                            <div>
                                                <div className="font-medium"
                                                     style={{color: headingColor}}>{project.name}</div>
                                                {project.description && (
                                                    <div className="text-xs"
                                                         style={{color: textMuted}}>{project.description}</div>
                                                )}
                                            </div>
                                        </div>
                                        <Button
                    ...
                    <div className="space-y-6">
                        <div className="rounded-xl p-6 border"
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div>
                                    <h3 className="text-lg font-semibold" style={{color: headingColor}}>Auto-Tagging
                                        nach Domain</h3>
                            ...
                            <div className="flex gap-2 mb-6 flex-wrap">
                                <Input value={newDomainRule.domain}
                                       onChange={(e) => setNewDomainRule({...newDomainRule, domain: e.target.value})}
                                       placeholder="Domain (z.B. @spluegen.ch)" className="flex-1 min-w-40"
                                       style={{backgroundColor: inputBg, borderColor: inputBorder, color: inputColor}}/>
                                <select value={newDomainRule.tag}
                                        onChange={(e) => setNewDomainRule({...newDomainRule, tag: e.target.value})}
                                        className="rounded-md px-3 py-2" style={{
                                    backgroundColor: inputBg,
                                    borderColor: inputBorder,
                                    color: inputColor,
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (!e.target.value) setNewDomainRule({...newDomainRule, customer_id: ''});
                                        }}
                                    ...
                                    {showCustomerDropdown && (
                                        <div
                                            className="absolute z-50 top-full left-0 mt-1 w-full rounded-md shadow-lg max-h-48 overflow-y-auto border"
                                            style={{backgroundColor: cardBg, borderColor: rowBorder}}>
                                            <div className="px-3 py-2 text-sm cursor-pointer" style={{color: textMuted}}
                                                 onMouseDown={() => {
                                                     setNewDomainRule({...newDomainRule, customer_id: ''});
                                                     setCustomerSearch('');
                            ...
                            <div className="space-y-2">
                                {domainRules.length === 0 ? (
                                    <p className="text-sm py-4" style={{color: textMuted}}>Keine Domain-Regeln
                                        definiert</p>
                                ) : (
                                        ...
                                        <div key={rule.id}
                                            ...
                                            <div className="flex items-center gap-3 flex-1">
                                                <div className="flex-1">
                                                    <div className="font-medium"
                                                         style={{color: headingColor}}>{rule.domain}</div>
                                                    <div className="text-xs" style={{color: textMuted}}>
                                                        → {rule.tag}
                                                        {rule.customer_id && customers.find(c => c.id === rule.customer_id) && (
                                                            <span
                                                                className="ml-2 text-emerald-500">| {customers.find(c => c.id === rule.customer_id)?.company_name}</span>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div className="rounded-xl p-6 border"
                            ...
                            <div className="flex items-center justify-between w-full">
                                ...
                                <div className="flex items-center gap-1">
                                    <Button variant="ghost" size="sm"
                                            onClick={() => exportAsCsv(activityTemplates, 'export_Tätigkeiten.csv')}
                                    ...
                                    <input
                                        ...
                                        ref={fileInputRef}
                                        onChange={(e) => {
                                            importFromCsv(e, 'activities')
                                        }}
                                        accept=".csv"
                                        className="hidden"
                                    />
                                    <Button variant="ghost" size="sm" onClick={() => fileInputRef.current.click()}
                                            className="h-7 px-2" style={{color: textMuted}} title="CSV importieren">
                                        <Download className="h-3.5 w-3.5"/>
                                    </Button>
                                </div>
                            </div>
                            <p className="text-sm mb-6" style={{color: textMuted}}>
                                Diese Tätigkeiten stehen für alle Kunden zur Verfügung und können dort einzeln als
                            ...
                            <div className="flex gap-2 mb-6">
                                <input
                                    ...
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter' && newActivityName.trim()) createActivityTemplateMutation.mutate({
                                            name: newActivityName.trim(),
                                            order: activityTemplates.length
                                        });
                                    }}
                                ...
                                />
                                <Button
                                    onClick={() => newActivityName.trim() && createActivityTemplateMutation.mutate({
                                        name: newActivityName.trim(),
                                        order: activityTemplates.length
                                    })}
                                    ...
                                    {(provided) => (
                                        <div ref={provided.innerRef} {...provided.droppableProps} className="space-y-2">
                                            {activityTemplates.length === 0 ? (
                                                <p className="text-sm py-4" style={{color: textMuted}}>Noch keine
                                                    Tätigkeiten definiert.</p>
                                            ) : (
                                                            ...
                                                            <div ref={provided.innerRef} {...provided.draggableProps}
                                                                ...
                                                                <div className="flex items-center gap-3 flex-1">
                                                                    ...
                                                                    <span className="text-sm"
                                                                          style={{color: headingColor}}>{activity.name}</span>
                                                                </div>
                                                                <Button
                                                                    variant="ghost"
                                                                    size="sm"
                ...
                {activeTab === 'users' && user?.role === 'admin' && (
                    <div>
                        <div className="rounded-xl p-6 border"
                             style={{backgroundColor: cardBg, borderColor: cardBorder}}>
                            <h3 className="text-lg font-semibold mb-4" style={{color: headingColor}}>Benutzer
                                verwalten</h3>
                            ...
                            <div className="mb-8 p-4 rounded-lg border"
                                ...
                                <div className="flex gap-2">
                                    <Input type="email" value={inviteEmail}
                                           onChange={(e) => setInviteEmail(e.target.value)} placeholder="E-Mail-Adresse"
                                           className="flex-1" style={{
                                        backgroundColor: inputBg,
                                        borderColor: inputBorder,
                                        color: inputColor
                                    ...
                                    <select value={inviteRole} onChange={(e) => setInviteRole(e.target.value)}
                                            className="rounded-md px-3 py-2 h-9 text-sm" style={{
                                        backgroundColor: inputBg,
                                        borderColor: inputBorder,
                                        color: inputColor,
                                        border: `1px solid ${inputBorder}`
                            ...
                            <div className="space-y-2">
                                <h4 className="text-sm font-medium mb-3" style={{color: textMuted}}>Benutzer &
                                    Einladungen</h4>
                                {users.length === 0 ? (
                                            ...
                                            <div key={u.id} className="rounded-lg border"
                                                ...
                                                <div className="flex items-center justify-between p-3 gap-3">
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        onClick={() => updateUserNameMutation.mutate({
                                                                            id: u.id,
                                                                            full_name: editingUserNameValue.trim(),
                                                                            titel: editingUserTitelValue.trim()
                                                                        })}
                                                            ...
                                                            <div className="flex items-center gap-1.5">
                                                                <div>
                                                                    <div className="font-semibold truncate"
                                                                         style={{color: headingColor}}>{u.full_name || u.email}</div>
                                                                    {u.titel && <div className="text-xs"
                                                                                     style={{color: textMuted}}>{u.titel}</div>}
                                                                </div>
                                                                <button
                                                                    onClick={() => {
                                                                        setEditingUserNameId(u.id);
                                                                        setEditingUserNameValue(u.full_name || '');
                                                                        setEditingUserTitelValue(u.titel || '');
                                                                    }}
                                                    ...
                                                    <div className="flex items-center gap-2 flex-shrink-0">
                                                        {editingUserId === u.id ? (
                                                            <>
                                                                <select value={editingUserRole}
                                                                        onChange={(e) => setEditingUserRole(e.target.value)}
                                                                        className="rounded-md px-2 py-1 text-xs h-7"
                                                                        style={{
                                                                            backgroundColor: inputBg,
                                                                            borderColor: inputBorder,
                                                                            color: inputColor,
                    ...
                    <div className="space-y-6">
                        <div className="rounded-xl p-6 border"
                            ...
                            <h3 className="text-lg font-semibold mb-1 flex items-center gap-2"
                                style={{color: headingColor}}>
                                <Download className="h-5 w-5"/> Desktop Apps
                            </h3>
                            <p className="text-sm mb-6" style={{color: textMuted}}>Windows-Hilfsprogramme für Artis
                                MailFlow</p>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm mb-3" style={{color: textMuted}}>
                                            ...
                                            Check-out / Check-in von Excel-, Word- und anderen Office-Dateien.
                                        </p>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        <h3 className="text-base font-semibold mb-1 flex items-center gap-2"
                                            ...
                                            className="text-xs font-normal opacity-50">Tauri v3.0.0</span>
                                        </h3>
                                        <p className="text-sm mb-3" style={{color: textMuted}}>
                                            Smartis als eigenständige Desktop-App für Windows. Läuft unabhängig vom Browser mit nativer Drag &amp; Drop Unterstützung.
                                        </p>
                                        <ul className="text-xs space-y-1" style={{color: textMuted}}>
                                            <li>✓ Flexible URL – beim ersten Start konfigurierbar, jederzeit via Tray-Icon änderbar</li>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm mb-3" style={{color: textMuted}}>
                                            ...
                                            zum Einfügen. Text erscheint sofort an der Cursor-Position.
                                        </p>
                                        <ul className="text-xs space-y-1" style={{color: textMuted}}>
                ...
                {activeTab === 'appearance' && (
                    <div className="space-y-6">
                        <div className="rounded-xl p-6 border"
                            ...
                            <p className="text-sm mb-6" style={{color: textMuted}}>Wähle dein bevorzugtes Design für die
                                Anwendung.</p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 max-w-2xl">
                                ...
                                <button
                                    onClick={async () => {
                                        setTheme('dark');
                                        await auth.updateMe({theme: 'dark'});
                                    }}
                                ...
                                >
                                    ...
                                    <div className="w-full h-36 bg-zinc-950 flex overflow-hidden">
                                        <div
                                            className="w-9 bg-zinc-900 border-r border-zinc-800 flex flex-col items-center py-2.5 gap-2 flex-shrink-0">
                                        ...
                                        <div className="flex-1 p-2 flex flex-col gap-2">
                                            ...
                                            <div className="flex gap-1.5 flex-1">
                                                <div
                                                    className="flex-1 rounded-lg bg-zinc-800/80 p-2 flex flex-col gap-1.5">
                                    ...
                                    <div className="p-4 flex items-center justify-between"
                                         style={{backgroundColor: theme === 'dark' ? 'rgba(124,58,237,0.08)' : cardBg}}>
                                        <div>
                                            <div className="flex items-center gap-2">
                                                <Moon className="h-4 w-4 text-violet-400"/>
                                                <span className="font-semibold text-sm"
                                                      style={{color: headingColor}}>Dunkel</span>
                                            </div>
                                            <p className="text-xs mt-0.5" style={{color: textMuted}}>Augenschonend bei
                                                Nacht</p>
                                        </div>
                                        {theme === 'dark' ? (
                                            <div
                                ...
                                <button
                                    onClick={async () => {
                                        setTheme('light');
                                        await auth.updateMe({theme: 'light'});
                                    }}
                                    className="group relative text-left rounded-2xl border-2 overflow-hidden transition-all duration-200 hover:scale-[1.02] hover:shadow-xl"
                                    style={{
                                ...
                                >
                                    ...
                                    <div className="w-full h-36 bg-slate-100 flex overflow-hidden">
                                        <div
                                            className="w-9 bg-slate-200 border-r border-slate-300 flex flex-col items-center py-2.5 gap-2 flex-shrink-0">
                                        ...
                                        <div className="flex-1 p-2 flex flex-col gap-2">
                                            ...
                                            <div className="flex gap-1.5 flex-1">
                                                <div
                                                    className="flex-1 rounded-lg bg-white border border-slate-200 p-2 flex flex-col gap-1.5">
                                    ...
                                    {/* Card Footer */}
                                    <div className="p-4 flex items-center justify-between"
                                         style={{backgroundColor: theme === 'light' ? 'rgba(124,58,237,0.06)' : cardBg}}>
                                        <div>
                                            <div className="flex items-center gap-2">
                                                <Sun className="h-4 w-4 text-amber-500"/>
                                                <span className="font-semibold text-sm"
                                                      style={{color: headingColor}}>Hell</span>
                                            </div>
                                            <p className="text-xs mt-0.5" style={{color: textMuted}}>Klassisch &
                                                klar</p>
                                        </div>
                                        {theme === 'light' ? (
                                            <div
                                ...
                                <button
                                    onClick={async () => {
                                        setTheme('artis');
                                        await auth.updateMe({theme: 'artis'});
                                    }}
                                    className="group relative text-left rounded-2xl border-2 overflow-hidden transition-all duration-200 hover:scale-[1.02] hover:shadow-xl"
                                    style={{
                                ...
                                >
                                    ...
                                    <div className="w-full h-36 flex overflow-hidden"
                                         style={{backgroundColor: '#f2f5f2'}}>
                                        <div
                                            className="w-9 flex flex-col items-center py-2.5 gap-2 flex-shrink-0 border-r"
                                            style={{backgroundColor: '#e6ede6', borderColor: '#bfcfbf'}}>
                                        ...
                                        <div className="flex-1 p-2 flex flex-col gap-2">
                                            ...
                                            <div className="flex gap-1.5 flex-1">
                                                <div className="flex-1 rounded-lg p-2 flex flex-col gap-1.5 border"
                                                     style={{
                                                         backgroundColor: 'rgba(255,255,255,0.75)',
                                                         borderColor: '#ccd8cc'
                                                     }}>
                                                    <div className="h-1.5 w-10 rounded-full"
                                                         style={{backgroundColor: '#bfcfbf'}}/>
                                                    <div className="h-1.5 w-14 rounded-full"
                                                         style={{backgroundColor: '#bfcfbf'}}/>
                                                    <div className="h-1.5 w-8 rounded-full"
                                                         style={{backgroundColor: '#7a9b7f80'}}/>
                                                </div>
                                                <div className="flex-1 rounded-lg p-2 flex flex-col gap-1.5 border"
                                                     style={{
                                                         backgroundColor: 'rgba(255,255,255,0.75)',
                                    ...
                                    {/* Card Footer */}
                                    <div className="p-4 flex items-center justify-between"
                                         style={{backgroundColor: theme === 'artis' ? 'rgba(122,155,127,0.1)' : cardBg}}>
                                        <div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-base font-bold leading-none"
                                                      style={{color: '#7a9b7f', fontFamily: 'serif'}}>A</span>
                                                <span className="font-semibold text-sm"
                                                      style={{color: headingColor}}>Artis</span>
                                            </div>
                                            <p className="text-xs mt-0.5" style={{color: textMuted}}>Grün &
                                                natürlich</p>
                                        </div>
                                        {theme === 'artis' ? (
                                            <div
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-xl p-6 border"
                            ...
                            <p className="text-sm mb-6" style={{color: textMuted}}>
                                ...
                                Mails werden nicht gesichert – sie können jederzeit über Outlook neu synchronisiert
                                werden.
                            </p>
                            ...
                            <div className="rounded-lg border p-4 mb-6 space-y-2"
                                ...
                                {[
                                    ...
                                    {
                                        icon: '📬',
                                        label: 'Kanban-Spalten & Zuweisungen',
                                        desc: 'kanban_columns, mail_kanban_mappings'
                                    },
                                    {icon: '🗂️', label: 'Aktivitätsvorlagen', desc: 'activity_templates'},
                                    {
                                        icon: '🏷️',
                                        label: 'Tags, Domain-Regeln, Prioritäten',
                                        desc: 'tags, domain_tag_rules, priorities'
                                    },
                                    {icon: '📁', label: 'Projekte & Mitarbeiter', desc: 'projects, staff'},
                                    {icon: '👤', label: 'Benutzerprofile', desc: 'profiles (ohne OAuth-Token)'},
                                    {
                                        icon: '📌',
                                        label: 'Kanban-Snapshot (outlook_id → Spalte)',
                                        desc: 'Ermöglicht Restore nach Mail-Reset'
                                    },
                                    {
                                        icon: '🎫',
                                        label: 'Support-Tickets & Nachrichten',
                                        desc: 'support_tickets, ticket_messages, ticket_columns'
                                    },
                                    ...
                                    <div key={item.label} className="flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <span className="text-sm font-medium"
                                                  style={{color: headingColor}}>{item.label}</span>
                                            <span className="text-xs ml-2"
                                                  style={{color: textMuted}}>({item.desc})</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            {/* Nicht enthalten */}
                            <div className="rounded-lg border border-amber-500/30 p-3 mb-6 flex items-start gap-2"
                                 style={{backgroundColor: 'rgba(245,158,11,0.06)'}}>
                                <span className="text-amber-500 text-base flex-shrink-0">⚠️</span>
                                <p className="text-xs" style={{color: textMuted}}>
                                    <strong style={{color: headingColor}}>Mail-Inhalte werden nicht
                                        gesichert.</strong>{' '}
                            ...
                            <div className="space-y-3 text-sm" style={{color: textMuted}}>
                                <div className="flex items-start gap-2">
                                    ...
                                    <p>
                                        ...
                                        <code
                                            className="text-xs bg-zinc-100 dark:bg-zinc-800 px-1 rounded">outlook_id</code>{' '}
                                    ...
                                    return (
                                        <>
                                            {lastSync ? (
                                                ...
                                                <div
                                                    className="p-3 rounded-lg border border-amber-500/30 flex items-center gap-2"
                                                    style={{backgroundColor: 'rgba(245,158,11,0.06)'}}>
                                                    <span className="text-amber-500 flex-shrink-0">⚠</span>
                                                    <p className="text-sm" style={{color: textMuted}}>Noch kein Sync
                                                        durchgeführt</p>
                                                </div>
                                            )}
                        ...
                        <div className="rounded-xl p-6 border"
                            ...
                            <ul className="space-y-2 text-sm" style={{color: textMuted}}>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-500 font-bold flex-shrink-0">✓</span>
                                    Neue E-Mails an support@artis-gmbh.ch werden automatisch als Tickets in der Spalte
                                    "Neu" angelegt
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-green-500 font-bold flex-shrink-0">✓</span>
                                ...
                                <li className="flex items-start gap-2">
                                    ...
                                    Nutzt dieselbe Microsoft App wie das bestehende Ticket-Reply-System (Client
                                    Credentials)
                                </li>
                            </ul>
                        </div>
