...
import {
  ...
  Users, UserCheck, UserX, Search, Filter, ExternalLink,
} from "lucide-react";
import {
...
/**
 * Telefon-Dashboard
 * Eigenständige Ansicht über alle Teams-Anrufe (Tabelle call_records).
 * KPI + Chart + Top-Listen + filterbare Liste.
 * Komplett separat, berührt keine bestehenden Seiten/Features.
 */
export default function TelefonDashboard() {
  ...
  const [dirFilter, setDirFilter] = useState("all"); // all|in|out|unmatched|matched
  ...
  if (isLoading) {
    return (
      <div style={{ padding: 32, color: subCol, backgroundColor: pageBg, minHeight: "100%" }}>
        Lade Telefonate …
      </div>
    );
  }
  if (error) {
    return (
      <div style={{ padding: 32, color: "#b04040", backgroundColor: pageBg, minHeight: "100%" }}>
  ...
  return (
    <div style={{ padding: 24, backgroundColor: pageBg, minHeight: "100%", overflow: "auto" }}>
      {/* ── Header ─────────────────────────────────────── */}
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 12.5, color: subCol, margin: "2px 0 0" }}>
            Übersicht über alle Microsoft-Teams-Anrufe · {calls.length} Anrufe geladen
          </p>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 12, marginBottom: 20 }}>
        <Card title="Anrufe pro Tag (letzte 30 Tage)" {...{ cardBg, border, headingCol, subCol }}>
      ...
      {/* ── Liste mit Filter ───────────────────────────── */}
      <Card title="Alle Anrufe" {...{ cardBg, border, headingCol, subCol }}>
