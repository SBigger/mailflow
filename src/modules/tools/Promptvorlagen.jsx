    ...
    <div className="flex flex-col h-screen w-screen overflow-auto" style={{ backgroundColor: pageBg }}>
      ...
      <div className="flex items-center gap-2 px-6 py-4 flex-shrink-0"
        ...
        <button
            ...
            style={{ color: subColor, background: "none", border: "none", cursor: "pointer", padding: 0 }}
        >Artis Tools</button>
        <ChevronRight className="w-3 h-3" style={{ color: subColor }} />
        <BookOpen className="w-4 h-4" style={{ color: accent }} />
        <span className="text-sm font-semibold" style={{ color: headingColor }}>Promtvorlagen</span>
      </div>
      {/* Header */}
      <div  className=" mb-5  px-6 py-5">
        ...
        {/* Suchfeld */}
        <div className="relative mb-5 max-w-sm mt-5">
