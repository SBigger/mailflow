...
const SECTIONS = [
  ...
  },
  {
    ...
    short: '📊',
    label: 'Auswertungen',
    paths: ['journal', 'kontobl', 'bilanz', 'mwst', 'jahresabschluss', 'bankabstimmung', 'kreditoren/journal'],
    items: [
      { to: 'kreditoren/journal',   label: 'Belegjournal',     icon: 'list' },
      { label: 'Kontoblätter',       icon: 'table',             disabled: true },
      { label: 'Bilanz & ER',        icon: 'balance',           disabled: true },
      { divider: true },
